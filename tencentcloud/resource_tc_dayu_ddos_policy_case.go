		...
		Schema: map[string]*schema.Schema{
			...
			"platform_types": {
				...
				Elem: &schema.Schema{
					...
					Description:  "Platform of the DDoS policy case. Valid values: `PC`, `MOBILE`, `TV` and `SERVER`.",
				},
				Required:    true,
			...
			"app_protocols": {
				...
				Elem: &schema.Schema{
					...
					Description:  "App protocol of the DDoS policy case. Valid values: `tcp`, `udp`, `icmp` and `all`.",
				},
				Required:    true,
