...
const testAccCamSAMLName = "cam-saml-provider-test"

func init() {
	// go test -v ./tencentcloud -sweep=ap-guangzhou -sweep-run=tencentcloud_cam_saml_provider
...
const SAMLProviderNameVar = `
variable "saml_provider_name" {
  default = "` + testAccCamSAMLName + `"
}
`

const testAccCamSAMLProvider_basic = SAMLProviderNameVar + `
...
const testAccCamSAMLProvider_update = SAMLProviderNameVar + `
resource "tencentcloud_cam_saml_provider" "saml_provider_basic" {
  name        = var.saml_provider_name
  meta_data   = ""
  description = "test2"
